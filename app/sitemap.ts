...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/deteccion-de-necesidades`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/diseno-instruccional-empresarial`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/implementacion-de-lms`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/academia-de-ventas`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/academia-de-servicio-al-cliente`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/universidades`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
