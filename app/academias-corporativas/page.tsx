  ...
  return (
    ...
    >
      ...
      <section className={s.section}>
        ...
        <h2 className={s.h2}>
          ¿Academia corporativa o universidad corporativa?
        </h2>
        <p className={s.prose}>
        ...
        <ul className={s.lista}>
          <li>
            <strong>Academia de ventas</strong> — onboarding comercial,
            producto, manejo de objeciones y práctica de cierre, para acortar
            la rampa de cada vendedor nuevo.
          </li>
          <li>
            <strong>Academia de servicio al cliente</strong> — criterio antes
            que guion: cursos donde el equipo practica clientes difíciles sin
            quemar clientes reales.
          </li>
          <li>
            <strong>Onboarding empresarial</strong> — los primeros 90 días
            resueltos: cultura, procesos y puesto, para que la rotación
            temprana deje de comerse tus contrataciones.
          </li>
          <li>
            <strong>Capacitación normativa</strong> — DC-3, NOM-035 y cursos
            obligatorios con registro y evidencia, sin teatro.
          </li>
          <li>
            <strong>Capacitación por industria</strong> — manufactura desde el
            celular en piso, retail con temporada alta, financiero con
            cumplimiento, salud con protocolos.
          </li>
          <li>
            <strong>Capacitación con inteligencia artificial</strong> — rutas
            personalizadas, práctica con retroalimentación y datos de
        ...
        <ul className={s.lista}>
          <li>
            <strong>El mapa de formación</strong> — qué debe saber cada
            puesto y en qué orden: rutas de aprendizaje por rol, no un
            catálogo alfabético de cursos.
          </li>
          <li>
            <strong>Los cursos, producidos</strong> — guion, pantallas,
            actividades, casos y evaluación de cada curso. Contenido a la
            medida de tu operación, con tu vocabulario y tus reglas.
          </li>
          <li>
            <strong>La plataforma operando</strong> — inscripciones
            automáticas, constancias, recordatorios y reportes que un humano
            puede leer sin exportar cinco archivos.
          </li>
          <li>
            <strong>El sistema de evidencia</strong> — cómo sabe la empresa
            que alguien ya está listo para operar: evaluaciones de
            desempeño, no exámenes de memoria.
          </li>
          <li>
            <strong>El método documentado</strong> — plantillas y criterios
            para que tu equipo produzca los siguientes cursos sin nosotros.
            La academia es tuya, no una renta.
          </li>
        </ul>
        ...
        <ul className={s.lista}>
          <li>
            <strong>Empezar por la plataforma</strong> — se compra el LMS
            primero y se decide qué enseñar después. Es construir el
            edificio antes de saber qué escuela va adentro.
          </li>
          <li>
            <strong>Subir lo que ya existía</strong> — los manuales de
            inducción y las presentaciones de la última convención no se
            vuelven cursos por estar en línea. Se vuelven evidencia de que
            nadie los abre.
          </li>
          <li>
            <strong>Querer todo el catálogo el primer día</strong> — cuarenta
            cursos mediocres pierden contra cinco cursos que la gente
            recomienda. La academia crece por reputación interna.
          </li>
          <li>
            <strong>Medir terminación en lugar de desempeño</strong> — el 95%
            de finalización con la operación igual que antes no es un logro:
            es una alarma con moño.
          </li>
          <li>
            <strong>Lanzar sin estrategia de arranque</strong> — la academia
            no se anuncia en un correo: se lanza como producto interno, con
            los jefes adentro primero.
          </li>
        </ul>
